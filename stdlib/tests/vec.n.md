...
fn main <()*>i32> ():
    ...
    set checks checks_push checks check is_empty_ref<i32> &v0_empty;
    free<i32> v0_empty;
    let v0_ptr <Vec<i32>> unwrap_ok new<i32>;
    set checks checks_push checks check gt data_ptr_ref<i32> &v0_ptr 0;
    free<i32> v0_ptr;
    ...
    let v2:
        ...
        |> push<i32> 10
        |> unwrap_ok
    set checks checks_push checks check_eq_i32 1 len_ref<i32> &v2;
    free<i32> v2;
    ...
    let v6:
        ...
        |> push<i32> 30
        |> unwrap_ok
    set checks checks_push checks check_eq_i32 3 len_ref<i32> &v6;
    free<i32> v6;
    ...
    let s2:
        ...
        |> push<i32> 20
        |> unwrap_ok
    replace_ref<i32> &s2 1 21;
    match get_ref<i32> &s2 1:
        Option::Some x:
            set checks checks_push checks check_eq_i32 21 x
        Option::None:
            set checks checks_push checks Result<(),str>::Err "replace get 1 returned None";
    free<i32> s2;
    let s2_ref:
        unwrap_ok new<i32>
        |> push<i32> 10
    ...
    let o1:
        ...
        |> push<i32> 10
        |> unwrap_ok
    set checks checks_push checks check is_none<i32> get_ref<i32> &o1 2;
    free<i32> o1;
    ...
    let p1:
        ...
        |> push<i32> 10
        |> unwrap_ok
    set checks checks_push checks check is_none<i32> get_ref<i32> &p1 -1;
    free<i32> p1;
...
fn main <()*>i32> ():
    ...
    set checks checks_push checks check_eq_i32 2 len_ref<i32> &filtered_len;
    ...
    match get_ref<i32> &filtered_get 1:
        Option::Some x:
            set checks checks_push checks check_eq_i32 4 x
        Option::None:
    ...
    let tuple_right <Vec<i32>>:
        unwrap_ok new<i32>
        |> push 1 |> uwok
    let tuple_parts <VecPartition<i32>> VecPartition<i32> tuple_left tuple_right
    let tuple_left_got <Vec<i32>> field::get tuple_parts "matched";
    let tuple_right_got <Vec<i32>> field::get tuple_parts "rest";
    ...
    free<i32> tuple_left_got;
    free<i32> tuple_right_got;
    ...
    let evens_len <Vec<i32>> field::get parts_even_len "matched";
    let rest_even_len <Vec<i32>> field::get parts_even_len "rest";
    set checks checks_push checks check_eq_i32 2 len_ref<i32> &evens_len;
    free<i32> evens_len;
    free<i32> rest_even_len;
    ...
    let evens_get <Vec<i32>> field::get parts_even_get "matched";
    let rest_even_get <Vec<i32>> field::get parts_even_get "rest";
    match get_ref<i32> &evens_get 1:
        Option::Some x:
            set checks checks_push checks check_eq_i32 4 x
        Option::None:
            set checks checks_push checks Result<(),str>::Err "vec partition evens returned None";
    free<i32> evens_get;
    free<i32> rest_even_get;
    ...
    let evens_odds_len <Vec<i32>> field::get parts_odds_len "matched";
    let odds_len <Vec<i32>> field::get parts_odds_len "rest";
    set checks checks_push checks check_eq_i32 2 len_ref<i32> &odds_len;
    free<i32> evens_odds_len;
    free<i32> odds_len;
    ...
    let evens_odds_get <Vec<i32>> field::get parts_odds_get "matched";
    let odds_get <Vec<i32>> field::get parts_odds_get "rest";
    match get_ref<i32> &odds_get 0:
        Option::Some x:
            set checks checks_push checks check_eq_i32 1 x
        Option::None:
            set checks checks_push checks Result<(),str>::Err "vec partition odds returned None";
    free<i32> evens_odds_get;
    free<i32> odds_get;
    ...
    set checks checks_push checks check_eq_i32 3 len_ref<i32> &taken;
    free<i32> taken;
