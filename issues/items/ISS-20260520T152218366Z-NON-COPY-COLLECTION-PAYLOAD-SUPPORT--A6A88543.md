...
- [ISS-20260521T043444492Z-COLLECTION-SLOT-LIFECYCLE-INTRINSIC--58368836](./ISS-20260521T043444492Z-COLLECTION-SLOT-LIFECYCLE-INTRINSIC--58368836.md) で、collection slot lifecycle intrinsic を包む stdlib wrapper / re-export が public safe API として user source へ漏れないことを静的検査する残件を分離した。Resource IR primitive は汎用化済みだが、export surface の検査が弱いと compiler-owned proof boundary が public convention に退行する。
