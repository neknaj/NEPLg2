...
- [ISS-20260521T163555637Z-COLLECTION-SLOT-SUMMARY-CANNOT-INSTA-02D58E62](./ISS-20260521T163555637Z-COLLECTION-SLOT-SUMMARY-CANNOT-INSTA-02D58E62.md) として、`CollectionSlotLifecycleSummaryPlace` の suffix 内に残る `ResourceOffset::Symbolic` / `ScaledSymbolic` の callee-local operand を caller argument へ再帰 instantiate できない設計問題を分離した。
