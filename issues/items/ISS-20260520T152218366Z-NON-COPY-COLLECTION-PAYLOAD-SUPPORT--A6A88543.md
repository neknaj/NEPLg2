...
- [ISS-20260520T200325099Z-COLLECTION-SLOT-LIFECYCLE-EFFECTS-DO-6E6407FC](./ISS-20260520T200325099Z-COLLECTION-SLOT-LIFECYCLE-EFFECTS-DO-6E6407FC.md) で、callee 内の slot lifecycle effect を caller の `CollectionSlotStateTable` へ伝播する typed summary が未実装であることを追跡する。
- [ISS-20260520T200531197Z-COLLECTION-SLOT-LIFECYCLE-HAS-NO-PRO-298A1B25](./ISS-20260520T200531197Z-COLLECTION-SLOT-LIFECYCLE-HAS-NO-PRO-298A1B25.md) で、実際の collection API semantics から `ResourceOp::CollectionSlotLifecycle` を発行する production lowering / annotation path が未実装であることを追跡する。
