...
- [ISS-20260521T082640712Z-COLLECTION-SLOT-INDIRECT-CALL-SUMMAR-6AB52846](./ISS-20260521T082640712Z-COLLECTION-SLOT-INDIRECT-CALL-SUMMAR-6AB52846.md) として、branch / match join 後の indirect call summary replay が callee alias と raw/slot state の path correlation を失う設計問題を分離した。これは未解決であり、path-correlated `ResourceCheckState` / `ResourcePathState` の導入単位として扱う。
