...
`stdlib/neplg2/` を NEPLg2.0 self-host compiler の正規ソースツリーとして追加した。
...
root `README.md` と `index.n.md` で、NEPLg3 placeholder ではなく NEPLg2.0 現行構文 / pipeline を対象にすること、`core/` と `cli/` を分離すること、focused check の入口を明示した。
`doc/neplg2/self_host_plan.md` の S0 に、現在の配置と検証コマンドを追記した。
