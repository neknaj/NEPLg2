...
async function run() {
    ...
    const result = await runSingle({
        id: "gui-font-web-registered-budgeted-run-driver/ready-reentry",
        source: `#entry main
#indent 4
#target std
...
fn main %impure fn void i32 \\void:
    gui_font_web_registered_budgeted_run_driver_test_ready_reentry_contract unit
`,
        file: path.resolve(__dirname, "..", "tests", "gui_font_web_registered_budgeted_run_driver_ready.nepl"),
