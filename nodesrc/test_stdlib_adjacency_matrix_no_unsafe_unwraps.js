...
assert.match(code, /fn\s+free\s+<\(AdjacencyMatrix\)->\(\)>[\s\S]*dealloc_raw\s+mem_ptr_addr\s+bits\s+nbytes/, 'AdjacencyMatrix.free must use raw owner cleanup for matrix storage');
