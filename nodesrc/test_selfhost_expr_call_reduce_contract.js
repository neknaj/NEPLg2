...
assert.match(
    ...
    "stage1 must run runtime smoke for non-ascribed pipe target unique-match, no-applicable, and duplicate-match cases",
);
assert.match(
    source,
