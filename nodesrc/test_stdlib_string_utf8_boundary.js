...
assert.match(rootCode, /fn\s+string_from_utf8_mem_result\b[\s\S]*string_utf8_validate_mem\s+src\s+byte_len/, "alloc/string root must keep checked str construction at the string ownership boundary");
