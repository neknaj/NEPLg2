...
assert.match(utf8Code, /fn\s+string_utf8_lead_kind\b[\s\S]*and\s+ge\s+b\s+0\s+le\s+b\s+127/, "alloc/string/utf8 must not classify negative sentinel bytes as ASCII");
