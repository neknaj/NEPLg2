...
const collectionUnwrapPostfixFixturePaths = [
    ...
    'stdlib/alloc/collections/bloom_filter/api.nepl',
    'stdlib/alloc/collections/btreemap/api/cleanup.nepl',
    'stdlib/alloc/collections/btreemap/api/create.nepl',
    'stdlib/alloc/collections/btreemap/api/insert.nepl',
    'stdlib/alloc/collections/btreemap/api/observer.nepl',
    'stdlib/alloc/collections/btreemap/api/remove.nepl',
    'stdlib/alloc/collections/btreeset/api/cleanup.nepl',
    'stdlib/alloc/collections/btreeset/api/create.nepl',
    'stdlib/alloc/collections/btreeset/api/insert.nepl',
    'stdlib/alloc/collections/btreeset/api/observer.nepl',
    'stdlib/alloc/collections/btreeset/api/remove.nepl',
    'stdlib/alloc/collections/counting_bloom_filter/api.nepl',
    'stdlib/alloc/collections/deque/api.nepl',
    'stdlib/alloc/collections/hashmap/api.nepl',
    'stdlib/alloc/collections/hashmap/types.nepl',
    'stdlib/alloc/collections/hashset/api.nepl',
    'stdlib/alloc/collections/hashset/types.nepl',
    ...
    'stdlib/alloc/collections/segment_tree/api/cleanup.nepl',
    'stdlib/alloc/collections/segment_tree/api/create.nepl',
    'stdlib/alloc/collections/segment_tree/api/query.nepl',
    'stdlib/alloc/collections/segment_tree/api/update.nepl',
    ...
    'tests/stdlib/btree_array_cost.n.md',
    ...
    'tests/stdlib/hash_collection_rehash.n.md',
