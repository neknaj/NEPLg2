...
function runNativeGuiPlatformBehaviorRegression() {
    ...
    assert.match(nativeWindowLinuxX11ObservationReaderImpl, /new_with_setup_request\([\s\S]*setup_backed_top_level_window_create_plan: None,[\s\S]*top_level_window_request: None,[\s\S]*NativeWindowLinuxX11TopLevelWindowRequestWriteState::NotConfigured,[\s\S]*top_level_window_request_written_len: 0,[\s\S]*top_level_window_request_sequence_plan: None,[\s\S]*wm_protocol_atom_intern_request_batch: None,[\s\S]*NativeWindowLinuxX11WmProtocolAtomInternBatchWriteState::NotConfigured,[\s\S]*wm_protocol_atom_intern_batch_written_len: 0,[\s\S]*wm_protocol_atom_intern_request_sequence_plan: None,[\s\S]*next_x11_request_sequence: NATIVE_WINDOW_LINUX_X11_FIRST_NORMAL_REQUEST_SEQUENCE,[\s\S]*pending_server_reply_header: None,[\s\S]*pending_server_reply_packet: None,[\s\S]*server_reply_body_remaining_len: 0/);
    ...
    assert.match(nativeWindowLinuxX11ObservationReaderImpl, /fn install_wm_protocol_atom_intern_request_batch[\s\S]*wm_protocol_atom_intern_request_batch: NativeWindowLinuxX11WmProtocolAtomInternRequestBatch[\s\S]*wm_protocol_atom_intern_request_batch = Some\(wm_protocol_atom_intern_request_batch\)[\s\S]*wm_protocol_atom_intern_batch_written_len = 0[\s\S]*wm_protocol_atom_intern_request_sequence_plan =[\s\S]*Some\(NativeWindowLinuxX11WmProtocolAtomInternRequestSequencePlan::new\(\)\)[\s\S]*NativeWindowLinuxX11WmProtocolAtomInternBatchWriteState::BatchPending/);
