...
function runNativeGuiPlatformBehaviorRegression() {
    ...
    assert.match(libSource, /pub struct NativeWindowRunLoopPlatformWaitBackendConfig\s*\{[\s\S]*selection: NativeWindowHostLoopPlatformWaitBackendSelection,[\s\S]*linux_event_source_capability: Option<NativeWindowHostLoopLinuxEventSourceCapability>/);
    assert.doesNotMatch(libSource, /pub struct NativeWindowRunLoopPlatformWaitBackendConfig\s*\{[\s\S]*pub selection:|pub struct NativeWindowRunLoopPlatformWaitBackendConfig\s*\{[\s\S]*pub linux_event_source_capability:/);
    ...
    assert.match(libSource, /impl NativeWindowRunLoopPlatformWaitBackendConfig[\s\S]*pub fn new\([\s\S]*selection: NativeWindowHostLoopPlatformWaitBackendSelection[\s\S]*linux_event_source_capability: None[\s\S]*pub fn new_with_linux_event_source_capability\([\s\S]*linux_event_source_capability: NativeWindowHostLoopLinuxEventSourceCapability[\s\S]*Some\(linux_event_source_capability\)[\s\S]*pub fn selection\(self\)[\s\S]*pub fn linux_event_source_capability/);
    ...
    assert.doesNotMatch(nativeWindowLinuxSelectorTimerFdBackend, /close_window_event_source|close_window_event_source_fd_raw/);
    assert.doesNotMatch(nativeWindowLinuxSelectorTimerFdBackend, /STATUS_WINDOW|WindowEventReady|WindowEventSourceReady|NativeWindowHostLoopWaitOutcome::HostEventPumpAlreadyPaced[\s\S]*window_event_source/);
    ...
    assert.match(libSource, /native_window_platform_wait_runner_support_rejects_linux_externally_wakeable_until_integrated/);
