...
function runNativeGuiPlatformBehaviorRegression() {
    ...
    assert.match(platformDoc, /resource id allocation、root window discovery、server error decode/);
