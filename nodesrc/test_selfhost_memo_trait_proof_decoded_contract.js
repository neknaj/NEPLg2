...
assert.match(
    tySources,
    /memo_trait_proof_index\.nepl",\s*"stdlib\/neplg2\/core\/ty\/ty\/memo_trait_proof_decoded\.nepl",\s*"stdlib\/neplg2\/core\/ty\/ty\/memo_trait_proof_preseed\.nepl"/,
    "decoded artifact owner must sit between sorted index construction and proof preseed in the TY source order",
);
assert.match(
    source,
