...
assertOrdered(
    ...
    [
        ...
        "Result::Ok summary:",
        "selfhost_memo_trait_operation_drop_impl_fact_from_summary type_id summary",
...
assertOrdered(
    ...
    [
        "selfhost_memo_trait_operation_drop_impl_fact_new type_id summary.effect summary.escape",
    ],
    "summary-to-fact helper must preserve effect and escape without masking",
);
assertOrdered(
