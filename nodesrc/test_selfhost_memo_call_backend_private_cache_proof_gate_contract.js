...
assertOrdered(
    ...
    "resource-lowering producer authority body-root helper must build coverage authority, produce sources, validate identity, issue fresh witness authority, and close sources on validation failure",
);
assert.doesNotMatch(
