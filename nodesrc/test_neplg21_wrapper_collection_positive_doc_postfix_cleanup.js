...
const collectionDirs = [
    ...
    "stdlib/alloc/collections/list",
    "stdlib/alloc/collections/queue",
    "stdlib/alloc/collections/ringbuffer",
];
...
assert.deepEqual(
    violations,
    [],
    `NEPLg2.1 wrapper collection positive doctests must not use old public helper postfix type arguments:\n${violations.join("\n")}`,
);

console.log("NEPLg2.1 wrapper collection positive doctest postfix cleanup regression passed");
