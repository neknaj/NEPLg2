...
#indent 4
#target std
#import "${testOnlyName.includes("tile_rle_count_start_bridge_test") ? "alloc/gui/font/registered_face/simple_glyph/indexed/stroke_compositor_tile_rle_count_start" : testOnlyName.includes("with_prepared_test_contract") ? "alloc/gui/font/registered_face/simple_glyph/indexed/stroke_source_contour" : "alloc/gui/font"}" as *
