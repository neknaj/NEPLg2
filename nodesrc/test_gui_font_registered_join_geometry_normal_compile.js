...
const testOnlyNames = [
    ...
    "gui_font_registered_face_simple_glyph_indexed_stroke_compositor_tile_rle_begin_frame_retry_policy_test_retry_contract",
    "gui_font_registered_face_simple_glyph_indexed_stroke_compositor_tile_rle_begin_frame_retry_policy_test_exhausted_contract",
    "gui_font_registered_face_simple_glyph_indexed_stroke_compositor_tile_rle_begin_frame_retry_policy_test_unsupported_candidate_contract",
    ...
    "gui_font_web_registered_begin_frame_retry_yield_scheduler_test_resume_contract",
    "gui_font_web_registered_begin_frame_retry_yield_scheduler_test_abort_contract",
    "gui_font_web_registered_begin_frame_retry_yield_scheduler_test_owner",
    "gui_font_web_registered_run_executor_test_success_contract",
    "gui_font_web_registered_run_executor_test_failure_contract",
    "gui_font_web_registered_end_frame_command_test_contract",
    "gui_font_web_registered_end_frame_command_test_non_continue_contract",
    "gui_font_web_registered_end_frame_command_test_all_contract",
    "gui_font_web_registered_end_frame_executor_test_contract",
    "gui_font_web_registered_terminal_completion_test_contract",
    "gui_font_web_registered_resumed_web_loop_test_contract",
    "gui_font_web_registered_resumed_web_loop_test_run_failure",
    "gui_font_web_registered_resumed_web_loop_test_runtime_contract",
    "gui_font_web_registered_unified_web_frame_test_contract",
    "gui_font_web_registered_run_success_phase_test_contract",
    "gui_font_web_registered_run_phase_driver_test_contract",
    ...
    "gui_font_registered_face_simple_glyph_indexed_stroke_compositor_tile_rle_begin_frame_resumed_run_host_request_test_contract",
    "gui_font_registered_face_simple_glyph_indexed_stroke_compositor_tile_rle_begin_frame_resumed_run_host_request_test_failure_contract",
...
const retryPolicyProbe = (testOnlyName) => `#entry main
#indent 4
#target std
#import "alloc/gui/font/registered_face/simple_glyph/indexed/stroke_compositor_tile_rle_begin_frame_retry_policy_test" as *
...
const webRetryExecutorProbe = (testOnlyName) => `#entry main
#indent 4
#target std
#import "platforms/gui/web/font_registered_begin_frame_retry_executor_test" as *
...
const webRetryYieldSchedulerProbe = (testOnlyName) => `#entry main
#indent 4
#target std
#import "platforms/gui/web/font_registered_begin_frame_retry_yield_scheduler_test" as *
...
const resumedRunHostRequestProbe = (testOnlyName) => `#entry main
#indent 4
#target std
#import "alloc/gui/font/registered_face/simple_glyph/indexed/stroke_compositor_tile_rle_begin_frame_resumed_run_host_request_test" as *
...
const webRunExecutorProbe = (testOnlyName) => `#entry main
#indent 4
#target std
#import "platforms/gui/web/font_registered_run_executor_test" as *
...
const webEndFrameCommandProbe = (testOnlyName) => `#entry main
#indent 4
#target std
#import "platforms/gui/web/font_registered_end_frame_command_test" as *
...
const webEndFrameExecutorProbe = (testOnlyName) => `#entry main
#indent 4
#target std
#import "platforms/gui/web/font_registered_end_frame_executor_test" as *
...
const webTerminalCompletionProbe = (testOnlyName) => `#entry main
#indent 4
#target std
#import "platforms/gui/web/font_registered_terminal_completion_test" as *
...
const webResumedLoopProbe = (testOnlyName) => `#entry main
#indent 4
#target std
#import "platforms/gui/web/font_registered_resumed_web_loop_test" as *
...
const webUnifiedFrameProbe = (testOnlyName) => `#entry main
#indent 4
#target std
#import "platforms/gui/web/font_registered_unified_web_frame_test" as *
...
const webRunSuccessPhaseProbe = (testOnlyName) => `#entry main
#indent 4
#target std
#import "platforms/gui/web/font_registered_run_success_phase_test" as *
...
const webRunPhaseDriverProbe = (testOnlyName) => `#entry main
#indent 4
#target std
#import "platforms/gui/web/font_registered_run_phase_driver_test" as *
