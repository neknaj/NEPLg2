...
for (const moduleName of [
    ...
    'collection_slot_drop_traversal_known_range.rs',
    'collection_slot_drop_traversal_range.rs',
    'collection_slot_drop_traversal_slots.rs',
    'collection_slot_drop_traversal_summary.rs',
    'collection_slot_drop_traversal_symbolic_range.rs',
    ...
    'collection_slot_payload_tracking.rs',
    'collection_slot_state_alias.rs',
    ...
    'collection_slot_summary_build_nested.rs',
    'collection_slot_summary_build_ops.rs',
    'collection_slot_summary_build_ops_tests.rs',
    'collection_slot_summary_build_range_bound.rs',
    'collection_slot_summary_build_range_certificate.rs',
    'collection_slot_summary_build_range_certificate_test_support.rs',
    'collection_slot_summary_build_range_certificate_tests.rs',
    'collection_slot_summary_build_range_lifetime.rs',
    'collection_slot_summary_build_range_lifetime_test_support.rs',
    'collection_slot_summary_build_range_lifetime_tests.rs',
    'collection_slot_summary_build_range_preserve.rs',
    'collection_slot_summary_build_range_preserve_op.rs',
    'collection_slot_summary_build_range_preserve_witness.rs',
    'collection_slot_summary_build_range_preserve_witness_op.rs',
    'collection_slot_summary_build_range_preserve_tests.rs',
    'collection_slot_summary_build_range_step.rs',
    'collection_slot_summary_build_range_step_expr.rs',
    'collection_slot_summary_build_tests.rs',
    'collection_slot_summary_build_value_cache.rs',
    'collection_slot_summary_build_range_witness.rs',
    'collection_slot_summary_build_range_witness_drop.rs',
    ...
    'collection_slot_summary_projection.rs',
    'collection_slot_summary_replay.rs',
    'collection_slot_summary_replay_drop_traversal.rs',
    'collection_slot_summary_replay_range_certificate_tests.rs',
    ...
    'collection_slot_summary_return_path_condition.rs',
    ...
    'collection_slot_state_release_alias.rs',
    'collection_slot_state_release_alias_precondition.rs',
    ...
    'collection_slot_storage_carrier_tests.rs',
    'collection_slot_storage_carrier_walk.rs',
    'owner_check.rs',
    ...
    'initialized_availability_collection.rs',
    'initialized_availability_diagnostic.rs',
    ...
    'i32_extent_proof.rs',
    'i32_scalar_return_facts_tests.rs',
    ...
    'initialized_function_check_value_cache.rs',
    'initialized_host_dependent.rs',
    'initialized_op_dispatch.rs',
    'initialized_path_state.rs',
    'initialized_path_state_merge.rs',
    'initialized_path_state_tests.rs',
    'initialized_raw_fill.rs',
    'initialized_raw_memory.rs',
    'initialized_raw_memory_access.rs',
    'initialized_raw_memory_bulk.rs',
    'initialized_raw_memory_dealloc_collection.rs',
    'raw_cell_lifecycle.rs',
    'raw_cell_lifecycle_alias.rs',
    'raw_cell_lifecycle_alias_tests.rs',
    'raw_cell_value_flow.rs',
    'raw_cell_value_flow_alias.rs',
    'raw_cell_value_flow_alias_candidates.rs',
    'raw_cell_value_flow_cell.rs',
    'raw_cell_value_flow_proof.rs',
    'raw_cell_value_flow_alias_scaled_tests.rs',
    'raw_cell_value_flow_alias_tests.rs',
    'raw_cell_value_flow_tests.rs',
    'initialized_rekey.rs',
    'initialized_scalar_flow.rs',
    'initialized_scalar_flow_value_cache.rs',
    'initialized_scalar_flow_value_cache_tests.rs',
    'initialized_scalar_flow_return_facts.rs',
    'initialized_scalar_flow_ops.rs',
    'initialized_scalar_flow_variant.rs',
    ...
    'initialized_summary_build_relevance.rs',
    'initialized_summary_build_tests.rs',
    'initialized_function_check_value_cache_tests.rs',
    'initialized_summary_build_value_cache_tests.rs',
    ...
    'initialized_summary_variant_model.rs',
    ...
    'place_utils.rs',
    'raw_pointer_type.rs',
    'resource_summary_value_cache.rs',
    'storage_origin.rs',
    'type_var.rs',
]) {
...
for (const moduleDecl of [
    ...
    'mod collection_slot_summary_build_value_cache;',
    ...
    'mod collection_slot_summary_return_path_condition;',
    ...
    'mod collection_slot_summary_return_path_variant;',
    ...
    'mod collection_slot_storage_carrier_walk;',
    'mod owner_check;',
    ...
    'mod initialized_path_state_merge;',
    ...
    'mod initialized_summary_build_relevance;',
...
const maxLines = new Map([
    ...
    ['collection_slot_drop_traversal.rs', 227],
    ...
    ['collection_slot_drop_traversal_symbolic_range.rs', 60],
    ...
    ['collection_slot_owner_carrier.rs', 120],
    ['collection_slot_owner_carrier_tests.rs', 120],
    ['collection_slot_owner_transfer.rs', 210],
    ['collection_slot_owner_transfer_proof.rs', 250],
    ['collection_slot_payload_tracking.rs', 40],
    ['collection_slot_event_target.rs', 40],
    ['collection_slot_state_alias.rs', 50],
    ['collection_slot_state_identity.rs', 40],
    ['collection_slot_summary_apply.rs', 180],
    ['collection_slot_summary_apply_return_path.rs', 256],
    ['collection_slot_summary_build.rs', 227],
    ['collection_slot_summary_build_drop_traversal.rs', 130],
    ['collection_slot_summary_build_event.rs', 80],
    ['collection_slot_summary_build_nested.rs', 120],
    ['collection_slot_summary_build_ops.rs', 620],
    ['collection_slot_summary_build_ops_tests.rs', 370],
    ...
    ['collection_slot_summary_build_range_preserve_op.rs', 183],
    ['collection_slot_summary_build_range_preserve_witness.rs', 180],
    ['collection_slot_summary_build_range_preserve_witness_op.rs', 180],
    ['collection_slot_summary_build_range_preserve_tests.rs', 180],
    ['collection_slot_summary_build_range_step.rs', 316],
    ['collection_slot_summary_build_range_step_expr.rs', 80],
    ['collection_slot_summary_build_tests.rs', 620],
    ['collection_slot_summary_build_value_cache.rs', 260],
    ...
    ['collection_slot_summary_model.rs', 149],
    ['collection_slot_summary_projection.rs', 230],
    ['collection_slot_summary_relevance.rs', 360],
    ['collection_slot_summary_relevance_tests.rs', 260],
    ['collection_slot_summary_replay.rs', 228],
    ['collection_slot_summary_replay_drop_traversal.rs', 90],
    ...
    ['collection_slot_summary_return_model.rs', 55],
    ['collection_slot_summary_return_path.rs', 60],
    ['collection_slot_summary_return_path_call.rs', 289],
    ['collection_slot_summary_return_path_condition.rs', 240],
    ['collection_slot_summary_return_path_control.rs', 227],
    ['collection_slot_summary_return_path_model.rs', 40],
    ['collection_slot_summary_return_path_slots.rs', 103],
    ['collection_slot_summary_return_path_state.rs', 306],
    ['collection_slot_summary_return_path_value.rs', 600],
    ['collection_slot_summary_return_path_variant.rs', 157],
    ...
    ['collection_slot_summary_translate.rs', 325],
    ['collection_slot_summary_translate_drop.rs', 137],
    ...
    ['collection_slot_storage_carrier_tests.rs', 100],
    ['collection_slot_storage_carrier_walk.rs', 120],
    ['collection_slot_state_merge.rs', 275],
    ...
    ['collection_slot_state_table.rs', 520],
    ['collection_slot_state_table_tests.rs', 202],
    ['collection_slot_state_transfer.rs', 734],
    ['collection_slot_state_transfer_tests.rs', 185],
    ['collection_slot_transform_range_certified.rs', 908],
    ...
    ['owner_host_payload_extent.rs', 490],
    ...
    ['owner_summary_i32_condition_leaf.rs', 195],
    ...
    ['i32_scalar_return_facts.rs', 767],
    ['i32_scalar_return_facts_tests.rs', 120],
    ['initialized_alias_flow.rs', 550],
    ['initialized_alias_flow_tests.rs', 240],
    ['initialized_alias_i32_condition.rs', 220],
    ['initialized_alias_i32_condition_context.rs', 120],
    ['initialized_alias_i32_condition_memo.rs', 100],
    ['initialized_alias_i32_condition_tests.rs', 101],
    ['initialized_alias_i32_bounds.rs', 80],
    ['initialized_alias_i32_facts.rs', 415],
    ['initialized_alias_i32_offset.rs', 340],
    ['initialized_alias_offset.rs', 143],
    ['initialized_alias_i32_relation_condition.rs', 120],
    ['initialized_alias_i32_scalar_alias.rs', 70],
    ['initialized_alias_i32.rs', 80],
    ['initialized_alias_origin.rs', 145],
    ...
    ['initialized_alias_scalar.rs', 205],
    ['initialized_alias_scalar_copy.rs', 100],
    ['initialized_alias_scale.rs', 144],
    ['initialized_alias_test_support.rs', 40],
    ['initialized_alias_utils.rs', 80],
    ['initialized_alias_tests.rs', 508],
    ['initialized_availability.rs', 120],
    ['initialized_availability_collection.rs', 120],
    ['initialized_availability_diagnostic.rs', 60],
    ['initialized_call.rs', 199],
    ...
    ['initialized_collection_slot_dispatch.rs', 130],
    ...
    ['initialized_collection_slot_transfer.rs', 91],
    ['initialized_control.rs', 1360],
    ...
    ['initialized_external_io_iov.rs', 140],
    ['initialized_external_io_payload.rs', 90],
    ['initialized_function_check_value_cache.rs', 140],
    ['initialized_host_dependent.rs', 90],
    ['initialized_op_dispatch.rs', 520],
    ['initialized_path_state.rs', 180],
    ['initialized_path_state_merge.rs', 100],
    ['initialized_path_state_tests.rs', 80],
    ...
    ['initialized_raw_memory_dealloc_collection.rs', 60],
    ['raw_cell_lifecycle.rs', 240],
    ['raw_cell_lifecycle_alias.rs', 50],
    ['raw_cell_lifecycle_alias_tests.rs', 80],
    ['raw_cell_value_flow.rs', 300],
    ['raw_cell_value_flow_alias.rs', 286],
    ['raw_cell_value_flow_alias_candidates.rs', 80],
    ['raw_cell_value_flow_alias_scaled_tests.rs', 90],
    ...
    ['initialized_scalar_flow.rs', 820],
    ['initialized_scalar_flow_return_facts.rs', 280],
    ['initialized_scalar_flow_ops.rs', 330],
    ['initialized_scalar_flow_variant.rs', 230],
    ...
    ['initialized_scalar_flow_value_cache.rs', 180],
    ['initialized_scalar_flow_value_cache_tests.rs', 380],
    ...
    ['initialized_function_check_value_cache_tests.rs', 140],
    ['initialized_summary_build_value_cache.rs', 200],
    ['initialized_summary_build_value_cache_eligibility.rs', 100],
    ['initialized_summary_build_value_cache_tests.rs', 220],
    ['initialized_summary_build_update.rs', 80],
    ['initialized_summary_build_relevance.rs', 160],
    ['initialized_summary_build_tests.rs', 120],
    ...
    ['initialized_summary_variant_model.rs', 60],
    ...
    ['initialized_variant_count.rs', 80],
    ...
    ['resource_summary_value_cache.rs', 340],
    ['storage_origin.rs', 320],
    ['summary_projection.rs', 966],
]);
