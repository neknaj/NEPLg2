...
for (const moduleName of [
    ...
    'initialized_alias_order.rs',
    'initialized_alias_type.rs',
...
const maxLines = new Map([
    ...
    ['owner_check.rs', 800],
    ['owner_flow.rs', 620],
    ['owner_raw_memory.rs', 240],
    ['owner_raw_view.rs', 180],
    ['owner_summary.rs', 380],
    ['owner_summary_cleanup.rs', 120],
    ['owner_summary_variant_build.rs', 360],
    ['owner_summary_variant_conditions.rs', 220],
    ['owner_summary_variant_construct.rs', 120],
    ['owner_summary_variant_entry.rs', 160],
    ['owner_summary_variant_paths.rs', 380],
    ['owner_summary_variant_return.rs', 220],
    ['owner_summary_variant_unique.rs', 80],
    ['owner_summary_leaf.rs', 260],
    ['owner_summary_record.rs', 260],
    ['owner_return.rs', 220],
    ['owner_return_summary.rs', 420],
    ['effect_check.rs', 700],
    ['summary.rs', 300],
