...
#indent 4
#target std
#import "alloc/gui/font/registered_face/simple_glyph/indexed/path_command_tag" as *
...
async function main() {
    ...
    for (const helperName of helperNames) {
        ...
        throw new Error(`F5nxh test-only helper unexpectedly compiled in normal mode: ${helperName}`);
    }
    console.log("F5nxh normal compile excludes all three #test entries");
}
