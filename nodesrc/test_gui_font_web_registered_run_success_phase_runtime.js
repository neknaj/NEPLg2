...
async function run() {
    ...
    const result = await runSingle({
        id: "gui-font-web-registered-run-success-phase/continue-yield",
        source: `#entry main
#indent 4
#target std
#import "platforms/gui/web/font_registered_run_success_phase_test" as * with tests

fn main %impure fn void i32 \\void:
    gui_font_web_registered_run_success_phase_test_contract unit
`,
        file: path.resolve(__dirname, "..", "tests", "gui_font_web_registered_run_success_phase.nepl"),
