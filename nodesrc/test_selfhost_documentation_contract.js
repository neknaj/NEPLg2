...
const DOC_SECTION_REQUIREMENTS = [
    ...
    requirement("stdlib/neplg2/core/proof/solver/effect.nepl", "selfhost_proof_effect_invalid", ["purpose", "contract", "returns", "complexity", "errorVariant", "authorityBoundary", "effectBoundary"], {
        requiredPatterns: [
            ...
            requiredPattern("private effect escape error", /\bSelfhostEffectBoundaryError::PrivateEffectEscapeNotProven\b/),
    ...
    requirement("stdlib/neplg2/core/proof/solver/effect.nepl", "selfhost_proof_private_effect_allowed", ["purpose", "contract", "returns", "complexity", "errorVariant", "effectBoundary"], {
        requiredPatterns: [
            requiredPattern("private state effect kind", /\bSelfhostEffectKind::PrivateState\b/),
            requiredPattern("private cache effect kind", /\bSelfhostEffectKind::PrivateCache\b/),
            requiredPattern("no-escape success state", /\bSelfhostEffectEscapeState::NoEscapeProven\b/),
            requiredPattern("not-applicable escape failure state", /\bSelfhostEffectEscapeState::NotApplicable\b/),
            requiredPattern("may-escape failure state", /\bSelfhostEffectEscapeState::MayEscape\b/),
            requiredPattern("private effect escape error", /\bSelfhostEffectBoundaryError::PrivateEffectEscapeNotProven\b/),
    ...
    requirement("stdlib/neplg2/core/proof/solver/effect.nepl", "selfhost_proof_solve_effect_pure_context", ["purpose", "contract", "returns", "complexity", "errorVariant", "effectBoundary"], {
        requiredPatterns: [
            ...
            requiredPattern("private state branch", /\bSelfhostEffectKind::PrivateState\b/),
            requiredPattern("private cache branch", /\bSelfhostEffectKind::PrivateCache\b/),
    ...
    requirement("stdlib/neplg2/core/hir/hir/expr.nepl", "selfhost_hir_expr_memoized_function_value", ["purpose", "contract", "complexity"]),
    requirement("stdlib/neplg2/core/lower/hir/function_value.nepl", "selfhost_memoized_function_value_identity_is_phase1_accepted", ["purpose", "contract", "returns", "complexity"]),
    requirement("stdlib/neplg2/core/lower/hir/function_value.nepl", "selfhost_memoized_function_value_identity_phase1_result", ["purpose", "contract", "returns", "complexity"]),
    requirement("stdlib/neplg2/core/lower/hir/function_value.nepl", "selfhost_hir_expr_memoized_function_value_from_identity", ["purpose", "contract", "returns", "complexity"]),
    requirement("stdlib/neplg2/core/lower/hir/function_value.nepl", "selfhost_hir_expr_memoized_function_value_from_candidate", ["purpose", "contract", "returns", "complexity"]),
