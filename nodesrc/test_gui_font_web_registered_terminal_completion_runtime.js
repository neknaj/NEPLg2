...
async function run() {
    ...
    const result = await runSingle({
        id: "gui-font-web-registered-terminal-completion/success",
        source: `#entry main
#indent 4
#target std
#import "platforms/gui/web/font_registered_terminal_completion_test" as * with tests

fn main %impure fn void i32 \\void:
    gui_font_web_registered_terminal_completion_test_contract unit
`,
        file: path.resolve(__dirname, "..", "tests", "gui_font_web_registered_terminal_completion.nepl"),
