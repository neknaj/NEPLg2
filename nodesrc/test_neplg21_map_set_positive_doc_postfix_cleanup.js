...
const collectionDirs = [
    "stdlib/alloc/collections/btreemap",
    "stdlib/alloc/collections/btreeset",
    "stdlib/alloc/collections/hashmap",
    "stdlib/alloc/collections/hashset",
];
...
assert.deepEqual(
    violations,
    [],
    `NEPLg2.1 map/set positive doctests must not use old public helper postfix type arguments:\n${violations.join("\n")}`,
);

console.log("NEPLg2.1 map/set positive doctest postfix cleanup regression passed");
