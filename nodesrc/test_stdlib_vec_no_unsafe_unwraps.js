...
assert.match(popSection, /OwnedBuffer<\.T>\s+next_len\s+next_len\s+v_cap/, 'Vec.pop success path must update initialized_len with len under the current Copy-only move-out contract');
