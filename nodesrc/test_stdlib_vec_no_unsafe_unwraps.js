...
assert.doesNotMatch(vecCode, /\bfield::get\s+\w+\s+"(?:len|cap|data)"/, 'Vec implementation must read header fields through field::get_ref so owner-consuming helpers do not move header fields');
