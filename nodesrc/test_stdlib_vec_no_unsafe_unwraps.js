...
assert.doesNotMatch(loaderCode, /&\["alloc",\s*"collections",\s*"vec",\s*"mutation",\s*"replace\.nepl"\]/, 'Vec mutation replace must not receive raw-memory boundary capability because it has no direct raw intrinsic');
