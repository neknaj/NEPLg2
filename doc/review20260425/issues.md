...
| [RV-CORE-022](./core.md#rv-core-022-github-actions-24940960078-で-compiler-doctest-が広範囲に回帰している) | false | open | P0 | bug | `wasi-test` / `nmd-doctest` が `tests` で 31 failed / 1 errored。compiler doctest 全体で再検証が必要 |
