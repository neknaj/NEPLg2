...
- [ISS-20260515T182630578Z-VEC-OWNER-RESULT-RETURN-TRIPS-RAW-ID-421E44DD](../../issues/items/ISS-20260515T182630578Z-VEC-OWNER-RESULT-RETURN-TRIPS-RAW-ID-421E44DD.md): `Result<Vec<T>, E>` owner return を raw identity escape と誤診断する Stage 6 core false positive。
...
| `VEC-OWNER-RESULT-RETURN-TRIPS-RAW-ID` | Stage 6 の Resource IR raw identity false positive。`Result<Vec<i32>, i32>` owner return が `resource.raw.identity_escape` になる。 | open。`i32` / `MemPtr` raw address leaf は拒否しつつ、`Vec` / `Result` owner carrier の内部 raw identity は protected owner return として扱う必要がある。 |
