...
| [gui_standard_library_spec.md](./gui_standard_library_spec.md) | GUI / TUI を共通 UI substrate として扱う標準ライブラリ仕様 |
| [gui_tui_implementation_plan.md](./gui_tui_implementation_plan.md) | `core/gui`、`alloc/gui`、`std/gui`、platform backend、既存 TUI 再設計の実装計画 |
