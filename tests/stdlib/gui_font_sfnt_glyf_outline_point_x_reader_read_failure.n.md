# GUI font SFNT glyf outline point x reader read failure doctests

このファイルは、F5h の PointX byte reader bridge が read failure で storage owner を失わず parse error を返すことを検査する。

## point x reader bridge preserves owner on read failure
...
fn main %impure fn void i32 \void:
    ...
    test_assertion_exit_code assert "outline point x reader read failure contract" point_x_read_failure_ok
```
