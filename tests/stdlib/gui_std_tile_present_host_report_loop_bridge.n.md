# GUI std row tile RLE present host report loop bridge doctests

このファイルは、F5cz の std layer RGBA8888 row tile RLE present host report loop bridge が、executor report を validation 後に dispatch loop completion へ戻すことを固定する。

source policy labels:

- std_row_tile_rle_present_host_report_loop_bridge_facade_ok
- std_row_tile_rle_present_host_report_loop_bridge_f5cv_f5cw_f5cx_f5cy_ok
- std_row_tile_rle_present_host_report_loop_bridge_validation_before_completion_ok
- std_row_tile_rle_present_host_report_loop_bridge_failed_report_completion_error_ok
- std_row_tile_rle_present_host_report_loop_bridge_state_preserved_ok
- std_row_tile_rle_present_host_report_loop_bridge_no_lower_no_platform_no_fallback

## host report loop bridge smoke

neplg2:test[stdio, normalize_newlines]
stdout: "test_report name=\"gui_std_tile_present_host_report_loop_bridge\" count=4 failed=0\nassertion index=0 status=ok kind=eq_i32 label=\"success report completes loop\" expected=\"1\" actual=\"1\" message=\"\"\nassertion index=1 status=ok kind=eq_i32 label=\"failed report becomes loop error\" expected=\"2\" actual=\"2\" message=\"\"\nassertion index=2 status=ok kind=eq_i32 label=\"unsupported support stops before completion\" expected=\"3\" actual=\"3\" message=\"\"\nassertion index=3 status=ok kind=eq_i32 label=\"wrong report action stops before completion\" expected=\"4\" actual=\"4\" message=\"\"\n"
exit_code: 0
```neplg2
#entry main
#target std
...
fn report_for_pending %fn &GuiRgba8888RowTileRlePresentDispatchLoopPendingRequest fn Result unit GuiError GuiRgba8888RowTileRlePresentHostExecutionReport \pending\outcome:
    let request gui_rgba8888_row_tile_rle_present_dispatch_loop_pending_request pending
    gui_rgba8888_row_tile_rle_present_host_execution_report_for_request &request outcome

fn wrong_end_report %fn void GuiRgba8888RowTileRlePresentHostExecutionReport \void:
    let descriptor %GuiRgba8888RowTileRlePresentDescriptor sample_descriptor
    ...
    gui_rgba8888_row_tile_rle_present_host_execution_report action Result::Ok unit
...
fn success_report_completes_loop_code %fn void i32 \void:
    ...
    let report %GuiRgba8888RowTileRlePresentHostExecutionReport report_for_pending &pending Result::Ok unit
    match gui_rgba8888_row_tile_rle_present_host_report_loop_bridge_complete GuiRgba8888RowTileRlePresentHostExecutorSupport::Offscreen pending report:
...
fn failed_report_becomes_loop_error_code %fn void i32 \void:
    let pending %GuiRgba8888RowTileRlePresentDispatchLoopPendingRequest sample_pending
    let report %GuiRgba8888RowTileRlePresentHostExecutionReport report_for_pending &pending Result::Err GuiError::BackendFailure
    match gui_rgba8888_row_tile_rle_present_host_report_loop_bridge_complete GuiRgba8888RowTileRlePresentHostExecutorSupport::All pending report:
        Result::Ok _completion:
            -1
        Result::Err error:
            match gui_rgba8888_row_tile_rle_present_host_report_loop_bridge_error_kind &error:
                GuiRgba8888RowTileRlePresentHostReportLoopBridgeErrorKind::LoopCompletionFailed lower:
                    match gui_rgba8888_row_tile_rle_present_dispatch_loop_error_kind &lower:
                        GuiRgba8888RowTileRlePresentDispatchLoopErrorKind::HostImportExecutionFailed host_error:
                            match host_error:
                                GuiError::BackendFailure:
                                    let state %GuiRgba8888RowTileRlePresentDispatchLoopState gui_rgba8888_row_tile_rle_present_host_report_loop_bridge_error_state &error
...
fn unsupported_support_stops_before_completion_code %fn void i32 \void:
    let pending %GuiRgba8888RowTileRlePresentDispatchLoopPendingRequest sample_pending
    let report %GuiRgba8888RowTileRlePresentHostExecutionReport report_for_pending &pending Result::Ok unit
    match gui_rgba8888_row_tile_rle_present_host_report_loop_bridge_complete GuiRgba8888RowTileRlePresentHostExecutorSupport::Window pending report:
        Result::Ok _completion:
            -1
        Result::Err error:
            match gui_rgba8888_row_tile_rle_present_host_report_loop_bridge_error_kind &error:
                GuiRgba8888RowTileRlePresentHostReportLoopBridgeErrorKind::ExecutorValidationFailed lower:
                    match gui_rgba8888_row_tile_rle_present_host_executor_error_kind &lower:
...
fn wrong_report_action_stops_before_completion_code %fn void i32 \void:
    let pending %GuiRgba8888RowTileRlePresentDispatchLoopPendingRequest sample_pending
    let report %GuiRgba8888RowTileRlePresentHostExecutionReport wrong_end_report
    match gui_rgba8888_row_tile_rle_present_host_report_loop_bridge_complete GuiRgba8888RowTileRlePresentHostExecutorSupport::Offscreen pending report:
        Result::Ok _completion:
            -1
        Result::Err error:
...
fn main %impure fn void i32 \void:
    let report:
        test::test_report_new "gui_std_tile_present_host_report_loop_bridge"
