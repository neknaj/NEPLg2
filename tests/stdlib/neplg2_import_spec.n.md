    ...
    match selfhost_import_spec_parse_lexeme source_span_new 0 0 26 "#import \"core/result\" as *":
        Result::Ok first:
            match selfhost_import_spec_parse_lexeme source_span_new 0 27 54 "#import \"std/test\" as test":
                Result::Ok second:
                    let first_span <SelfhostSourceSpan> *field::get_ref &first "span"
                    let first_wildcard <bool> *field::get_ref &first "is_wildcard"
                    let second_wildcard <bool> *field::get_ref &second "is_wildcard"
                    let first_path <str> field::get first "path"
                    let first_alias <str> field::get first "alias"
                    let second_path <str> field::get second "path"
                    let second_alias <str> field::get second "alias"
                ...
                Result::Err _diag:
                    selfhost_import_spec_free first
...
fn main <()*>i32> ():
    ...
    match selfhost_import_spec_parse_lexeme span "#import":
        Result::Ok _spec:
            selfhost_import_spec_free _spec
