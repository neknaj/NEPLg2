...
fn main %impure fn unit i32 \unit:
    let mut s %Stack i32 unwrap_ok new;
    set s unwrap_ok push s 10;
    set s unwrap_ok push s 20;
...
fn main %impure fn unit i32 \unit:
    ...
    let s3 %Stack i32 unwrap_ok push s2 30;
...
fn main %impure fn unit i32 \unit:
    let mut s %Stack i32 unwrap_ok new;
    set s unwrap_ok push s 0;
    set s unwrap_ok push s 1;
    set s unwrap_ok push s 2;
    set s unwrap_ok push s 3;
    set s unwrap_ok push s 4;
    set s unwrap_ok push s 5;
    set s unwrap_ok push s 6;
    set s unwrap_ok push s 7;
    set s unwrap_ok push s 8;
    set s unwrap_ok push s 9;
    let grown_len %i32 len &s;
    set s clear s;
    let clear_len %i32 len &s;
    free s;
    let mut next %Stack i32 unwrap_ok new;
    set next unwrap_ok push next 42;
    let top_ok %bool match peek &next:
        Option::Some v:
            eq v 42
        Option::None:
            false
