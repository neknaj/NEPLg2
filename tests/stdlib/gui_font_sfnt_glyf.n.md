        ...
        Result::Ok bytes:
            let next_report %TestReport match gui_sfnt_lookup_simple_glyph_contour_edge &bytes none glyph1 0 0:
                ...
                Result::Ok edge:
                    ...
                    let r3 %TestReport test_report_push r2 assert_eq_i32 "contour edge first start absolute index" 0 gui_sfnt_simple_glyph_point_index &start_point
                    let r4 %TestReport test_report_push r3 assert_eq_i32 "contour edge first end absolute index" 1 gui_sfnt_simple_glyph_point_index &end_point
                    test_report_push r4 assert "contour edge first end contour end" gui_sfnt_simple_glyph_point_end_of_contour &end_point
            io_bytebuf_free bytes
            next_report
