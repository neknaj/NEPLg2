# GUI font SFNT glyf outline point x reader push failure doctests

このファイルは、F5h の PointX byte reader bridge が valid read 後の push failure で rejected point と owner を保持することを検査する。

## point x reader bridge preserves point on push failure
...
fn main %impure fn void i32 \void:
    ...
    test_assertion_exit_code assert "outline point x reader push failure contract" point_x_read_push_failure_ok
```
