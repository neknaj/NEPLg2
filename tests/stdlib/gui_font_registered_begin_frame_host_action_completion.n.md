...
fn main %impure fn void i32 \void:
    ...
    let report2 %TestReport test_report_push report1 (assert_eq_i32 "unsupported rejoins continuation" 12 unsupported)
