...
fn new %fn void i32 \void:
    7

fn new %fn void bool \void:
    true
...
fn build %fn void Result i32 str \void:
    Result::Ok 9

fn build %fn void Result bool str \void:
    Result::Ok true
...
fn build %impure fn void Result i32 str \void:
    Result::Ok 1

fn build %impure fn void Result bool str \void:
    Result::Ok true
...
fn new %impure fn void Vec i32 \void:
...
fn make_i32 %fn void i32 \void:
    choose 1

fn make_bool %fn void bool \void:
    choose 1
