...
#if[target=wasi]
fn skipped %fn void i32 \void:
    unknown_symbol_a

fn not_skipped %fn void i32 \void:
    unknown_symbol_b
...
fn skipped_bad %fn void i32 \void:
    unknown_symbol
...
#if[target=linux]
fn hidden_linux_only %fn void i32 \void:
    unknown_symbol
...
#if[target=linux]
fn only_linux %fn void i32 \void:
    7
