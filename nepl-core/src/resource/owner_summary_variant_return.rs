...
use super::summary::{
    OwnerProjectionReturnSummary, OwnerProjectionSource, OwnerVariantProjectionReturn,
    OwnerVariantProjectionReturnKind,
};
        ...
        for parameter_index in &projection.parameter_indices {
            ...
            push_unique_variant_projection_return(
                ...
                OwnerVariantProjectionReturn {
                    ...
                    ty: projection.ty,
                    kind: OwnerVariantProjectionReturnKind::Parameter(source),
                },
            );
        }
        for source in &projection.parameter_sources {
            push_unique_variant_projection_return(
                ...
                OwnerVariantProjectionReturn {
                    ...
                    suffix: projection.suffix.clone(),
                    ty: projection.ty,
                    kind: OwnerVariantProjectionReturnKind::Parameter(source.clone()),
                },
            );
        }
        if projection.returns_fresh_owner {
            push_unique_variant_projection_return(
                ...
                OwnerVariantProjectionReturn {
                    ...
                    suffix: projection.suffix.clone(),
                    ty: projection.ty,
                    kind: OwnerVariantProjectionReturnKind::FreshOwner,
                },
            );
        }
        if projection.returns_maybe_owner {
            push_unique_variant_projection_return(
                ...
                OwnerVariantProjectionReturn {
                    ...
                    suffix: projection.suffix.clone(),
                    ty: projection.ty,
                    kind: OwnerVariantProjectionReturnKind::MaybeOwner,
                },
            );
        }
    }
