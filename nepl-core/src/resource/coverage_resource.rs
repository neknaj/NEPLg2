...
use super::coverage_resource_collection_slot::{
    collection_slot_drop_traversal_coverage, collection_slot_lifecycle_coverage,
    collection_storage_relocate_coverage,
};
    ...
    for op in ops {
        match op {
            ...
            ResourceOp::CollectionSlotLifecycle { target, span, .. } => {
                collection_slot_lifecycle_coverage(function, target, *span, counts, diagnostics);
            }
