...
use super::model::{
    AggregateKind, BorrowKind, BorrowState, BorrowStateEntry, OwnerState, OwnerStateEntry, Place,
    RawMemoryOp, ResourceBlock, ResourceCallTarget, ResourceFunction, ResourceModule, ResourceOp,
    ResourceTerminator,
};
...
use super::report::{
    ...
    ResourceBorrowFunctionCheck, ResourceBorrowOperation, ResourceOwnerCheckDeferred,
    ResourceOwnerCheckReport, ResourceOwnerDiagnostic, ResourceOwnerFunctionCheck,
    ResourceOwnerOperation,
};
use super::summary::{
