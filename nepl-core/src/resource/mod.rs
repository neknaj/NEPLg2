...
mod collection_slot_summary_i32_operand;
...
mod initialized_summary_build_update;
mod initialized_summary_build_value_cache;
mod initialized_summary_build_value_cache_eligibility;
...
pub use initialized::{
    check_resource_initialized_moves, check_resource_initialized_moves_with_summary_cache,
};
