...
impl RawMemoryIdentityTable {
    pub(super) fn contains(&self, pointer_aliases: &RawPointerAliasTable, place: &Place) -> bool {
    ...
    pub(super) fn mark(&mut self, pointer_aliases: &RawPointerAliasTable, place: &Place) {
