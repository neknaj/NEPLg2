...
- `ISS-20260601T193116311Z-NEPLMETA-TRAIT-IMPL-MATERIALIZER-NEEDED-D3A0C2F1` に沿って、Web / loader の `.neplmeta` projection 成功結果を `PublicInterfaceArtifactInputs` へ変換し、import / prelude body skip と source fallback 実測へ接続する
