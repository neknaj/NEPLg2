...
- `ISS-20260604T034255066Z-SELFHOST-PARSER-AND-CHECKER-DO-NOT-I-7C1C8941` の次 slice として、declaration body envelope から複数 expression segment を切り出す body segmenter を追加し、`SelfhostExprPrefixList` を expected type / overload / generic / no partial application を含む call reduction へ渡す
