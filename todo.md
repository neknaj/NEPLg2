...
- `ISS-20260604T034255066Z-SELFHOST-PARSER-AND-CHECKER-DO-NOT-I-7C1C8941` の次 slice として、block / lambda / borrow / pipe argument expression checking、generic instantiation inference、trait solving、`@ident` argument match payload / call reduction result から function value HIR lowering boundary へ接続する処理、indirect call、`memo_call` Phase 1 境界を追加する
