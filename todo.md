...
- `ISS-20260531T134951396Z-I32-SCALAR-RESIDUAL-REPROJECTION-STI-0F6F5A24` に沿って、i32 scalar stable mirror の `ParameterProjection` / `ScalarType` 再投影境界を修正し、RPN edit の i32 residual `+16` を解消する
