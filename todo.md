...
- `ISS-20260604T034255066Z-SELFHOST-PARSER-AND-CHECKER-DO-NOT-I-7C1C8941` の次 slice として、数値 / bool / char / string literal value payload と NamedValue の DefId-linked HIR variable identity を設計し、`TypedExpression` へ丸めている argument を source 再読なしで HIR expression tree へ lowering できる形に分解する
