...
- `ISS-20260604T034255066Z-SELFHOST-PARSER-AND-CHECKER-DO-NOT-I-7C1C8941` の次 slice として、checked argument list を HIR direct call lowering へ接続し、`FunctionValue(candidate)` payload を `core/lower/hir/function_value` 経由で `SelfhostHirExprPayload::FnValue` へ変換する処理を追加する
