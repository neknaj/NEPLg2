...
- `ISS-20260601T150700000Z-NEPLMETA-CALLABLE-REJECT-NEEDS-FINE-GRA-9D4F2A61` に沿って、field accessor 復元後に残る `type.public_surface.materializer.callable_rejected` を細分化し、次の metadata root blocker を特定する
