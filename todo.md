...
- `stdlib/string-numeric-overflow` branch で `ISS-20260426T060156433Z-STRING-NUMERIC-PARSERS-WRAP-OVERFLOW-E952EC90` に沿って numeric parser の overflow を `Result::Err` へ統一する
