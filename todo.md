...
- `ISS-20260604T034255066Z-SELFHOST-PARSER-AND-CHECKER-DO-NOT-I-7C1C8941` の次 slice として、`%T` ascription 由来の `SelfhostTypeExpectation` を type resolver / TypeArena projection と接続し、candidate collection、argument type checking、diagnostic projection を追加する
