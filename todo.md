...
- Web Playground の `GuiWebEvent` pointer down / up / cancel checkpoint を、pointer move coalescing、keyboard / text input / window / timer / lifecycle variant、session id formalization へ拡張する
