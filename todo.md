...
- Web Playground の `GuiWebEvent` action record poll checkpoint を、pointer move / keyboard / text input / window / timer / lifecycle variant と session id formalization へ拡張する
