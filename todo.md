...
- `compiler/wildcard-result-i64-pattern` branch で `ISS-20260426T061837095Z-WILDCARD-RESULT-I64-PATTERN-CAN-GENE-C5C0C655` に沿って `Result<i64,_>` wildcard pattern の stack/drop 生成を修正する
...
- `rust/selfhost-req-hashkey-runner` branch で `ISS-20260426T053112317Z-SELFHOST-REQ-HASHKEY-FIXTURE-FAILS-U-34A22E8C` に沿って selfhost_req HashKey fixture の target / harness 契約を修正する
