...
- `ISS-20260524T225852366Z-PER-PROGRAM-COMPILE-TIME-EXCEEDS-DEF-189918C5` に沿って、RPN base compile `compile_ms=9231` / `resource_static_check=8606.798ms` を 0.5 秒未満へ近づけるため、stdlib prechecked artifact と Resource proof template の設計を実装へ落とす
