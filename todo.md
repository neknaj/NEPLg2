...
- `ISS-20260604T034255066Z-SELFHOST-PARSER-AND-CHECKER-DO-NOT-I-7C1C8941` の次 slice として、`TypedExpression` / `NestedDirectCall` / `BlockResult` を含む checked argument payload を HIR expression tree へ lowering する処理を追加する
