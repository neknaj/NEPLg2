...
- `ISS-20260601T145100000Z-NEPLMETA-FIELD-ACCESSOR-MATERIALIZER-NEEDED-4F6A0C2B` に沿って、`type.public_surface.materializer.field_accessor_unsupported` を解消する field accessor callable materializer を実装する
