...
- `ISS-20260601T193116311Z-NEPLMETA-TRAIT-IMPL-MATERIALIZER-NEEDED-D3A0C2F1` と `ISS-20260531T111205690Z-BINARY-INTERMEDIATE-ARTIFACTS-NEEDED-1C570649` に沿って、`NeplObjDirectCallKey` を `CompilerSession` の object availability store と `PublicInterfaceArtifactInputs` の direct-call body resolver へ接続する
