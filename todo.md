...
- `ISS-20260604T034255066Z-SELFHOST-PARSER-AND-CHECKER-DO-NOT-I-7C1C8941` の次 slice として、declaration header range evidence の先にある flat prefix expression/type AST、kind-directed type application resolver、expected type / overload / generic / no partial application を含む call reduction を実装する
