...
- `ISS-20260531T075621000Z-RAW-ALIAS-RESIDUAL-REPROJECTION-VAL-9A5D0C3E` に沿って、raw alias stable mirror 後に残った reprojection value bypass を細分し、safe に replay できる surface を追加する
- `ISS-20260531T071956084Z-RAW-INIT-RESIDUAL-RECOMPUTATIONS-NEE-C36FBACE` に沿って、raw-init 残再計算を function-local source capability invalidation へ狭める
...
- `ISS-20260531T035335856Z-MEMO-CALL-NEEDS-TYPED-FUNCTION-IDENT-3B612E6C` に沿って、高階関数値を string name ではなく typed function identity で扱う
