...
- `ISS-20260601T193116311Z-NEPLMETA-TRAIT-IMPL-MATERIALIZER-NEEDED-D3A0C2F1` と `ISS-20260531T111205690Z-BINARY-INTERMEDIATE-ARTIFACTS-NEEDED-1C570649` に沿って、`body_missing_candidate_surfaces_delta_sum` が大きい compile を実測し、`.neplobj` stable link symbol / selected callable body hash / generic instantiation hash の schema を実装する
