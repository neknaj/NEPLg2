...
- `ISS-20260604T034255066Z-SELFHOST-PARSER-AND-CHECKER-DO-NOT-I-7C1C8941` の次 slice として、source / token backed の nested call / block / lambda / borrow / pipe argument expression checking、generic instantiation inference、trait solving、`@function` / indirect call を追加する
