...
- `ISS-20260601T193116311Z-NEPLMETA-TRAIT-IMPL-MATERIALIZER-NEEDED-D3A0C2F1` と `ISS-20260531T111205690Z-BINARY-INTERMEDIATE-ARTIFACTS-NEEDED-1C570649` に沿って、`CompilerSession` の object availability store と direct-call codegen fragment payload を `PublicInterfaceArtifactInputs::nepl_obj_direct_call_keys` へ接続する
