...
- `ISS-20260601T193116311Z-NEPLMETA-TRAIT-IMPL-MATERIALIZER-NEEDED-D3A0C2F1` と `ISS-20260531T111205690Z-BINARY-INTERMEDIATE-ARTIFACTS-NEEDED-1C570649` に沿って、body-missing skip 後も残る `compile_ms` を下げるため、direct call に限定した `.neplobj` stable link symbol / selected callable body hash / generic instantiation hash の schema と availability resolver を実装する
