...
- `ISS-20260601T193116311Z-NEPLMETA-TRAIT-IMPL-MATERIALIZER-NEEDED-D3A0C2F1` に沿って、`UnsupportedExportKind` で止まっている trait / struct / enum export と semantic impl registry materializer を実装する
